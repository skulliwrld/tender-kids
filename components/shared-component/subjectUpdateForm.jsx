          ...
          <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-500 p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">View Subject</h2>
                  <p className="text-purple-100 text-sm">Subject details</p>
                </div>
              </div>
              <button 
          ...
          <form action={async (formData) => {
            ...
            <div className="space-y-2">
              ...
              <input 
                ...
                readOnly={isTeacher}
                className="w-full px-4 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-gray-900 bg-gray-50"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                readOnly={isTeacher}
                className="w-full px-4 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-gray-900 bg-gray-50 resize-none"
              />
            </div>
